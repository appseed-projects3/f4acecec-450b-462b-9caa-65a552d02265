...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-06-29 07:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f4acecec-450b-462b-9caa-65a552d02265.git
$ cd f4acecec-450b-462b-9caa-65a552d02265
```
